...
export const Admin: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'groups' | 'scripts'>('groups');
          ...
          <div className="flex items-center">
            ...
            <div className="mr-4">
              <p className="text-2xl font-bold text-gray-800">
                {groups.reduce((total, group) => total + group.participantCount, 0)}
              </p>
              <p className="text-gray-600">משתתפים כ"ע</p>
            </div>
          </div>
        </div>
      </div>
